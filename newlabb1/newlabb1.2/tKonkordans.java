    ...
    public static void main(String[] args){
      ...
      try {
        ...
        for (String key : properties.stringPropertyNames()) {
          ...
          //String blabla = "aa";
          //hashedSearchWord = String.valueOf(hashWord(blabla));
          //String testtest = hm.get(hashedSearchWord);
          //Integer testaa = Integer.parseInt(testtest);
          ...
          RandomAccessFile raf2 = new RandomAccessFile(new File("wordList.txt"), "r");
          raf2.seek(indexPosition);
          String apapa = raf2.readLine();
          System.out.println("Line in wordList: "+apapa);
...
/*
        ...
        //System.out.println("indexPosition: " + indexPosition);
        RandomAccessFile raf = new RandomAccessFile(new File("ut.txt"), "r");
        ...
        while (start <= end)
        {
            counter2++;
            m = start + (end-start)/2;
            m = m-(m%1); //avrundar nedåt genom modulering
            raf.seek(m);
            raf.readLine();
        ...
        System.out.println("THE WORD: "+word[0]+" THE LINE: "+line);
